 ...
 * Created on January 10, 2019, 8:26 AM
 * Purpose: How much diet soda can I drink before reaching the expiration date!  
 *
 */
...
int main(int argc, char** argv) {
    ...
    float   wD,//Weight in lbs of the dieter
            ms,//Mass of sweetener that killed mause in grams
